...
if __name__ == "__main__":
    my_rec_1 = Rectangle(8, 4)
    my_rec_2 = Rectangle(2, 3)

    if my_rec_1 is Rectangle.bigger_or_equal(my_rec_1, my_rec_2):
        print("my_rec_1 is bigger or equal to my_rec_2")
    else:
        print("my_rec_2 is bigger than my_rec_1")
